<div>
    ...
    <div
        ...
        <div
            class="flex items-center justify-between gap-2.5 border-b border-b-border px-5 py-2.5 text-sm font-semibold text-mono"
                            ...
                            <div class="kt-card bg-muted/70 gap-3.5 rounded-lg p-3.5 shadow-none">
                                <div class="flex flex-wrap items-center justify-between gap-2.5">
                                    ...
                                    <div class="flex -space-x-2">
                                        <div class="flex">
                                            <img
                                                class="hover:z-5 relative size-6 shrink-0 rounded-full ring-1 ring-background"
